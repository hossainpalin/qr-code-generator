  ...
  return (
    <main className="w-full h-full bg-gray-200 flex flex-col items-start overflow-auto p-6">
      ...
      <div className="container max-w-7xl flex flex-wrap lg:flex-nowrap gap-4">
        <div className="w-full lg:w-[65%] bg-white rounded-lg shadow-sm p-6 flex flex-col h-full max-h-fit">
          <QRCodeInputter />
        </div>
        <div className="w-full flex flex-col items-start lg:w-[35%] bg-white rounded-lg shadow-sm p-6 h-full max-h-fit sticky top-0">
          <QRCodeGenerator />
        </div>
      </div>
    </main>
